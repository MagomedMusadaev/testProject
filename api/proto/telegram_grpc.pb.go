...
const (
	TelegramService_CheckUserInChannel_FullMethodName = "/telegram.TelegramService/CheckUserInChannel"
)
...
func (c *telegramServiceClient) CheckUserInChannel(ctx context.Context, in *CheckUserRequest, opts ...grpc.CallOption) (*CheckUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckUserResponse)
	err := c.cc.Invoke(ctx, TelegramService_CheckUserInChannel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTelegramServiceServer) CheckUserInChannel(context.Context, *CheckUserRequest) (*CheckUserResponse, error) {
...
func _TelegramService_CheckUserInChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TelegramServiceServer).CheckUserInChannel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TelegramService_CheckUserInChannel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TelegramServiceServer).CheckUserInChannel(ctx, req.(*CheckUserRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _TelegramService_CheckUserInChannel_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/proto/telegram.proto",
}
